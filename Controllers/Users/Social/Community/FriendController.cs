...
namespace mpc_dotnetc_user_server.Controllers.Users.Social.Community
{
    ...
    public class FriendController : ControllerBase
    {
        ...
        public async Task<ActionResult<string>> Read_End_User_Friend_Permission_Data(Friends_PermissionDTO dto)
        {
            ...
            return await Task.FromResult(AES.Process_Encryption(Users_Repository_Read.Read_End_User_Friend_Permissions_By_ID(dto.End_User_ID_Parsed).Result));
        }
        ...
        public async Task<ActionResult<string>> Update_Friend_Approve_Permission(Friends_PermissionDTO dto)
        {
            ...
            return await Task.FromResult(AES.Process_Encryption(Users_Repository_Update.Update_Friend_Permissions(new Friends_Permission
            {
        ...
        [HttpPut("Unblock")]
        public async Task<ActionResult<string>> Update_Friend_Unblock_Permission(Friends_PermissionDTO dto)
        {
            if (!ModelState.IsValid)
                return BadRequest();
