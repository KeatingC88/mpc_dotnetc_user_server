...
namespace mpc_dotnetc_user_server.Controllers.Users.Social.Community
{
    [ApiController]
    [Route("api/Report")]
    public class ReportController : ControllerBase
    {
        ...
        public async Task<ActionResult<bool>> EmailRegister([FromBody] Reported_Broken_LinkDTO dto)
        {
            try
            {
                ...
                return await Task.FromResult(Users_Repository_Create.Create_Broken_Link_Record(new Reported_Broken_Link {
        ...
        public async Task<ActionResult<bool>> ContactUsRegister([FromBody] Contact_UsDTO dto)
        {
            try
            {
                ...
                return await Task.FromResult(Users_Repository_Create.Create_Contact_Us_Record(new Contact_Us {
                    End_User_ID = dto.End_User_ID,
        ...
        public async Task<ActionResult<bool>> DiscordBotBugRegisterRegister([FromBody] Reported_Discord_Bot_BugDTO dto)
        {
            try
            {
                ...
                return await Task.FromResult(Users_Repository_Create.Create_Discord_Bot_Bug_Record(new Reported_Discord_Bot_Bug {
                    End_User_ID = dto.End_User_ID,
                    Location = dto.Location,
                    Detail = dto.Detail,
                })).Result;
        ...
        public async Task<ActionResult<bool>> Comment_BoxRegister([FromBody] Comment_BoxDTO dto)
        {
            try
            {
                ...
                return await Task.FromResult(Users_Repository_Create.Create_Comment_Box_Record(new Comment_Box
                {
                    End_User_ID = dto.End_User_ID,
                    Comment = dto.Comment,
                })).Result;
        ...
        public async Task<ActionResult<string>> Report_User([FromBody] ReportedDTO dto)
        {
           ...
           if (!System_Tampering.Validate_Client_With_Server_Authorization(new Report_Failed_Authorization_History
            ...
            await Task.FromResult(Users_Repository_Create.Create_Reported_Record(new Reported
            {
            ...
            await Task.FromResult(Users_Repository_Update.Update_Chat_Web_Socket_Permissions(new WebSocket_Chat_Permission
            {
                End_User_ID = dto.End_User_ID_Parsed,
                Participant_ID = dto.Participant_ID_Parsed,
                Requested = false,
            ...
            await Task.FromResult(Users_Repository_Update.Update_Friend_Permissions(new Friends_Permission
            {
                End_User_ID = dto.End_User_ID_Parsed,
                Participant_ID = dto.Participant_ID_Parsed,
                Requested = false,
        ...
        public async Task<ActionResult<bool>> Website_BugRegister([FromBody] Reported_Website_BugDTO dto)
        {
            try
            {
                ...
                return await Task.FromResult(Users_Repository_Create.Create_Website_Bug_Record(new Reported_Website_Bug {
                    End_User_ID = dto.End_User_ID,
                    URL = dto.URL,
                    Detail = dto.Detail,
                })).Result;
