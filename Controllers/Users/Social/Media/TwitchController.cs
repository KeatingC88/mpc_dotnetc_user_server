    ...
    public class TwitchController : ControllerBase
    {
        ...
        public async Task<ActionResult<string>> Validating_Twitch_Login([FromBody] Validate_Twitch_LoginDTO dto)
        {
            try
            {
                ...
                bool user_twitch_id_exists = Users_Repository_Read.Read_ID_Exists_In_Twitch_IDs(user_twitch_id).Result;
                bool twitch_email_exists = Users_Repository_Read.Read_Email_Exists_In_Twitch_Email_Address(user_email).Result;

                if (user_twitch_id_exists && twitch_email_exists) {

                    mpc_id = Users_Repository_Read.Read_User_ID_By_Twitch_Account_Email(user_email).Result;
                    ...
                    mpc_member_data = Users_Repository_Create.Create_Account_By_Twitch(new Complete_Twitch_Registeration
                    {
        ...
        public async Task<ActionResult<string>> Integrate_Twitch_Email([FromBody] Integrate_TwitchDTO dto)
        {
            try
            {
                ...
                await Users_Repository_Integrate.Integrate_Account_By_Twitch(new Complete_Twitch_Integration
                {
