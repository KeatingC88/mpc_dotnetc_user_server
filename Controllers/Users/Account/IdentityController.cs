    ...
    public class IdentityController : ControllerBase
    {
        ...
        public async Task<ActionResult<string>> Process_End_User_First_Name([FromBody] IdentityDTO dto)
        {
            try
            {
                ...
                return await Task.FromResult(Users_Repository.Update_End_User_First_Name(dto)).Result;
            } catch (Exception e) {
        ...
        public async Task<ActionResult<string>> Process_End_User_Last_Name([FromBody] IdentityDTO dto)
        {
            try
            {
                ...
                return await Task.FromResult(Users_Repository.Update_End_User_Last_Name(dto)).Result;
            } catch (Exception e) {
                return StatusCode(500, $"{e.Message}");
            }
        }
        ...
        public async Task<ActionResult<string>> Process_End_User_Middle_Name([FromBody] IdentityDTO dto)
        {
            try
            {
                ...
                return await Task.FromResult(Users_Repository.Update_End_User_Middle_Name(dto)).Result;
            }
            catch (Exception e)
            {
                return StatusCode(500, $"{e.Message}");
        ...
        public async Task<ActionResult<string>> Process_End_User_Maiden_Name([FromBody] IdentityDTO dto)
        {
            try
            {
                ...
                return await Task.FromResult(Users_Repository.Update_End_User_Maiden_Name(dto)).Result;
            } catch (Exception e) {
                return StatusCode(500, $"{e.Message}");
            }
        }
        ...
        public async Task<ActionResult<string>> Process_End_User_Gender([FromBody] IdentityDTO dto)
        {
            try
            {
                ...
                return await Task.FromResult(Users_Repository.Update_End_User_Gender(dto)).Result;
            } catch (Exception e) {
                return StatusCode(500, $"{e.Message}");
            }
        }
        ...
        public async Task<ActionResult<string>> Process_End_User_Ethnicity([FromBody] IdentityDTO dto)
        {
            try
            {
                ...
                return await Task.FromResult(Users_Repository.Update_End_User_Ethnicity(dto)).Result;
            } catch (Exception e) {
                return StatusCode(500, $"{e.Message}");
            }
        }
        ...
        public async Task<ActionResult<string>> Process_End_User_Birth_Date([FromBody] IdentityDTO dto)
        {
            try
            {
                ...
                return await Task.FromResult(Users_Repository.Update_End_User_Birth_Date(dto)).Result;
            }
            catch (Exception e)
            {
                return StatusCode(500, $"{e.Message}");
